...
public class camper {
	...
	public static void main(String[] args) throws InterruptedException, IOException{
		...
		driver.findElement(By.id("numberofseats")).sendKeys("6");
		...
		driver.findElement(By.id("listprice")).sendKeys("2500");
		driver.findElement(By.id("licenseplatenumber")).sendKeys("MH 13");
		...
		FileUtils.copyFile(src, new File("C:\\selenium\\Screenshot4.jpeg"));
