...
public class Truck {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		driver.findElement(By.id("dateofmanufacture")).sendKeys("07/12/2000");
		driver.findElement(By.id("numberofseats")).sendKeys("5");
		driver.findElement(By.id("fuel")).sendKeys("Petrol");
		driver.findElement(By.id("payload")).sendKeys("142");
		driver.findElement(By.id("totalweight")).sendKeys("230");
		driver.findElement(By.id("listprice")).sendKeys("1000");
		driver.findElement(By.id("licenseplatenumber")).sendKeys("Mh13");
		...
		//THIRD PAGE
		driver.findElement(By.id("startdate")).sendKeys("03/06/2025");
		...
		FileUtils.copyFile(src, new File("C:\\selenium\\Screenshot1.jpeg"));
